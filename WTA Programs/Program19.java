/*
 2. Write java program to demonstrate the following String functions : a. length() b.
isEmpty(), isBlank() c. charAt() d. equals(),equalsIgnoreCase() e. compareTo() and
compareToIgnoreCase() f. startsWith() and endsWith() g. substring() h. concat() i.
replace(), replaceFirst(), and replaceAll() j. contains() k. reverse(); l. split() m. join() n.
toLowerCase() and toUpperCase() o. trim( )
 */
class Program19 {
