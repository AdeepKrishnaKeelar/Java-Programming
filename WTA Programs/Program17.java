/*
17. Write a program in java to read filename from user, read data from file using File
Reader and improve its efficiency and display the contents of the file
 */
import java.io.*;
